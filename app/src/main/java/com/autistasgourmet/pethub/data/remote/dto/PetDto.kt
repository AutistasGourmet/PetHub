...
data class PetDto(
    ...
    val affectionTraits: List<String> = emptyList(),
    val energyTraits: List<String> = emptyList(),
    val intelligenceTraits: List<String> = emptyList(),
    val instinctTraits: List<String> = emptyList(),
